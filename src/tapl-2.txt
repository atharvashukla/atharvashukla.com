...
- 2 - Mathematical Preliminaries
  - 2.1 - Sets, Relations, and Functions
    ...
    - 2.1.8 - **partial function**, when tuples with t1, 2 belong to R, and t1 = t2. **total function** when domain of R is S (ffunc from S to T)
  ...
  - 2.2 - ordered sets
    ...
    - 2.2.3 j is **join**(lub) iff s <= j, t <= j and for any k in S, s <= k, t <= k we have j <= k. 
    **meet** (glb): m <= s, m <= t. for any n in S, n <= s and n <= t. n <= m
    - reflexive, transitive, symmetric relation on S -- **equivalence** on S
    - 2.2.5 reflexive **closure**, transitive closure. 
    - EX 2.2.6 ...
    - EX 2.2.7 ...
    - EX 2.2.8 ...
  ...
  - 2.5 Background reading: _Winskel_, _David and Priestley_, _Halmos_. 
